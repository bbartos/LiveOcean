"""
Extract a mooring-like record for a list of NDBC buoys.
...
This runs with default values (Two days in July 2016)
python roms_moor0.py

This changes the days to run
python moor_ndbc.py -d0 2015.07.10 -d1 2015.08.01
"""
...
# for NDBC buoys
sn_dict={'46088':['48.334','-123.165'],'46087':['48.494','-124.728'],'46041':['47.353','-124.731'],
...
#parser.add_argument('-sn', '--sn', nargs='?', const=sn, type=str, default=sn)
...
# Run through station list
for sn in sn_dict:
    Ldir['sn'] = sn

    # Station coordinates
    Ldir['lon_str'] = sn_dict[sn][1]
    Ldir['lat_str'] = sn_dict[sn][0]
    ...
    # Generating variable lists based on dimensions
